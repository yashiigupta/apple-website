            ...
            <div className='flex flex-col w-full relative'>
              <div className='feature-video-container'>
                <div className='overflow-hidden flex-1 h-[50vh]'>
                  <img src = {"/assets/images/explore1.jpg"} alt = "explore1-image" className='feature-video g_grow'/>
                </div>
                <div className='overflow-hidden flex-1 h-[50vh]'>
                  <img src = {"/assets/images/explore2.jpg"} alt = "explore2-image" className='feature-video g_grow'/>
                </div>
              </div>
